...
- **投影仪 / 大屏。** 会议室投影的对比度和色域都远低于屏幕，`#CCF224` 打到幕布上会糊成一片荧光，黑字边缘发晕。**如果白板经常上大屏，硬派不能当默认。** 这条直接连着「未决」第 1 条。
...
这三条堵在这儿，不解决就不要动手写产品代码。

1. **第一次打开的人，默认看到哪一套？** 这个决定连着上面「投影仪」那条——如果白板经常上大屏，硬派就不该当默认。
